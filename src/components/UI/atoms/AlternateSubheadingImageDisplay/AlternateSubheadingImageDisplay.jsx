...
const AlternateSubheadingImageDisplay = ({extra_class = "", image_height, image_width, image_class, image_source = {template_image}}) => {
  return (
    <div className= {extra_class=="" ? "alternate-base-image-display": extra_class + " alternate-base-image-display"}>
